...
<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
          <div class="block">
            <a href="index.html"><img src="<?php echo URLROOT; ?>/images/logo-alt.png" alt="footer-logo"></a>
            <!-- Social Site Icons -->
  ...
  <script src="<?php echo URLROOT; ?>/plugins/bootstrap/bootstrap.min.js"></script>
  <script src="<?php echo URLROOT; ?>/plugins/slick/slick.min.js"></script>
  <script src="<?php echo URLROOT; ?>/plugins/fancybox/jquery.fancybox.min.js"></script>
  <script src="<?php echo URLROOT; ?>/plugins/syotimer/jquery.syotimer.min.js"></script>
  <script src="<?php echo URLROOT; ?>/plugins/aos/aos.js"></script>
  <!-- google map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
  <script src="<?php echo URLROOT; ?>/plugins/google-map/gmap.js"></script>
